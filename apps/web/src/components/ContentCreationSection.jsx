  ...
  const pillars = [
    {
      ...
      label: '01',
      title: 'Criar',
      desc: 'Visual, posts e templates alinhados à marca — com hierarquia clara para prender atenção.',
    ...
    },
    {
      ...
      label: '02',
      title: 'Publicar',
      desc: 'Calendário editorial e agendamento nos horários certos, sem operação manual desorganizada.',
    ...
    },
    {
      ...
      label: '03',
      title: 'Otimizar',
      desc: 'Campanhas e métricas em ciclo contínuo — o que performa escala, o que não performa sai.',
