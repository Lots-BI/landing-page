  ...
  return (
    <section className="py-24 md:py-32 relative z-10 overflow-hidden bg-transparent">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <AnimatedSection className="max-w-4xl mx-auto flex flex-col items-center justify-center text-center bg-card/80 backdrop-blur-2xl p-10 md:p-20 rounded-[3rem] border border-primary/20 shadow-[0_0_32px_hsla(var(--primary)/0.06)]">
          ...
          <PlanosCtaButton 
            className="text-lg px-8 py-4 shadow-[0_0_14px_hsla(142,71%,45%,0.12)] hover:shadow-[0_0_18px_hsla(142,71%,45%,0.2)]"
          >
            Quero um Orçamento
          </PlanosCtaButton>
        </AnimatedSection>
